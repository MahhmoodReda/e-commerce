        ...
        <div class="container">
            <div class="p-b-10">
                <h3 class="ltext-103 cl5">
                    <div class=""><span class="text-primary">New</span> Arrivals</div>
                </h3>
            </div><br>
            <div>
                    ...
                    <div class="w-full wrap-filter flex-w bg6 p-lr-40 p-t-27 p-lr-15-sm">
                                ...
                                @foreach ($categories as $category)
                                    <li class="p-b-6">
                                        <div class="form-check">
                                            <input class="form-check-input" wire:model.live='categoryInputs'
                        ...
                        <div class="filter-col2 p-r-15 p-b-27">
                            ...
                            <ul>
                                @foreach ($brands as $brand)
                                    <li class="p-b-6">
                                        <div class="form-check">
                                            <input class="form-check-input" wire:model.live='brandInputs'
                                                type="checkbox" value="{{ $brand->id }}" id="{{ $brand->name }}">
                        ...
                        <div class="filter-col3 p-r-15 p-b-27">
                            ...
                            <ul>
                                <li class="p-b-6">
                                    <div class="form-check">
                                        <input class="form-check-input" name="pricesort" wire:model.live='priceInput'
                                            type="radio" value="high-to-low" id="price">
                                ...
                                <li class="p-b-6">
                                    <div class="form-check">
                                        <input class="form-check-input" name="pricesort" wire:model.live='priceInput'
                                            type="radio" value="low-to-high" id="price1">
