    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    {{-- a global variable sent from appServiceProvider have all categories --}}
                    @foreach($categories as $category)

                    <li class="p-b-10">
                        <a href="{{ route('user.categoryProduct',$category->slug) }}" class="stext-107 cl7 hov-cl1 trans-04">
                            {{ $category->name }}
                        </a>
                    </li>
                    @endforeach
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="{{ route('user.orders') }}" class="stext-107 cl7 hov-cl1 trans-04">
                            Orders
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="{{ route('user.shop') }}" class="stext-107 cl7 hov-cl1 trans-04">
                            shop
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="{{ route('user.cart') }}" class="stext-107 cl7 hov-cl1 trans-04">
                            Cart
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="{{ route('user.wishlist') }}" class="stext-107 cl7 hov-cl1 trans-04">
                            wishlist
                        </a>
                    </li>
                </ul>
